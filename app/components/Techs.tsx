...
export default function Techs({techs}: {techs: Tech[]}) {
    return (
        <div className="p-16 w-screen md:w-auto grid grid-rows-2 grid-flow-col md:grid-flow-row overflow-y-hidden overflow-x-auto md:overflow-x-hidden md:grid-cols-4 lg:grid-cols-6 content-start gap-12">
            <AnimatePresence>
